<?php $__env->startSection('title', 'Kafolat xizmati | Baraka Development'); ?>
            ...
            <div class="row g-3 mb-9">
                <div class="col-12">
                    <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                        <img src="<?php echo e(asset('back/img/bannerlar/kafolat-xizmati.png')); ?>" alt="reja">
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/barakarasmiy/resources/views/frontend/pages/kafolat-xizmati.blade.php ENDPATH**/ ?>