<?php $__env->startSection('title', 'Kompaniya haqida | Baraka Development'); ?>
		...
		<div class="row g-3 mb-9">
			<div class="col-12">
				<div class="whooping-banner w-100 rounded-3 overflow-hidden">
					<img src="<?php echo e(asset('back/img/bannerlar/biz-haqimizda.jpg')); ?>" alt="bizhaqimizda">
				</div>
			</div>
		</div>
	</div>
...
<section class="counter-container p-0 pb-10">
	...
	<div class="bg-holder d-none d-lg-block"
		style="background-image:url('<?php echo e(asset('back/img/bg/bg-left-25.png')); ?>');background-size:auto;background-position:left center;">
	</div>
	<!--/.bg-holder-->

	<div class="bg-holder d-none d-lg-block"
		style="background-image:url('<?php echo e(asset('back/img/bg/bg-right-25.png')); ?>');background-size:auto;background-position:right center;">
	</div>
	<!--/.bg-holder-->
	...
	<div class="container px-lg-9 px-xxl-3">
		<div class="row flex-between-center px-xl-11 mb-10 mb-md-9">
			...
			<div class="col-md-5 mb-5 mb-md-0 text-center">
				<video class="w-100 w-md-100" src="<?php echo e(asset('back/video/haqida.mp4')); ?>" type="video/mp4"
					controls></video>
			</div>
		</div>
</section>
					...
					<div class="row g-3">
						<div class="col-4">
							<?php $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<a href="<?php echo e($gallery->photo); ?>" data-gallery="gallery-photos">
										<img class="w-75 rounded-3" src="<?php echo e($gallery->photo); ?>" alt="<?php echo e($gallery->photo); ?>" />
									</a>
								</div>
...
<?php $__env->startPush('scripts'); ?>
	...
	<script src="<?php echo e(asset('back/vendors/countup/countUp.umd.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/barakarasmiy/resources/views/frontend/pages/about-us.blade.php ENDPATH**/ ?>