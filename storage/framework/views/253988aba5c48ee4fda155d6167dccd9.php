...
<head>
    ...
    <!-- bootstrap grid css -->
    <link rel="stylesheet" href="<?php echo e(asset('barakajobs/css/plugins/bootstrap-grid.css')); ?>">
    <!-- font awesome css -->
    <link rel="stylesheet" href="<?php echo e(asset('barakajobs/css/plugins/font-awesome.min.css')); ?>">
    <!-- swiper css -->
    <link rel="stylesheet" href="<?php echo e(asset('barakajobs/css/plugins/swiper.min.css')); ?>">
    <!-- fancybox css -->
    <link rel="stylesheet" href="<?php echo e(asset('barakajobs/css/plugins/fancybox.min.css')); ?>">
    <!-- ashley scss -->
    <link rel="stylesheet" href="<?php echo e(asset('barakajobs/css/style.css')); ?>">
    <!-- page name -->
    <title>Barakada ish | Baraka Development</title>
...
<body>
    ...
    <div class="mil-wrapper" id="top">
            ...
            <div class="mil-preloader-animation">
                ...
                <div class="mil-pos-abs mil-animation-2">
                    <div class="mil-reveal-frame">
                        ...
                        <p class="mil-h3 mil-muted mil-thin">barakarasmiy.uz</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mil-menu-frame">
            ...
            <div class="mil-frame-top">
                <a href="home-1.html" class="mil-logo">Baraka Development</a>
                        ...
                        <div class="container mil-p-120-60">
                            <div class="row justify-content-between">
                                <div class="col-md-4 col-lg-4 mil-mb-60">
                                    ...
                                    <div class="mil-muted mil-logo mil-up mil-mb-30">Baraka Development</div>
                                            ...
                                            <nav class="mil-footer-menu mil-mb-60">
                                                <ul>
                                                    <li class="mil-up mil-active">
                                                        <a href="home-1.html">Bosh sahifa</a>
                                                    </li>
                                                    <li class="mil-up">
                            ...
                            <div class="row justify-content-between flex-sm-row-reverse">
                                <div class="col-md-7 col-lg-6">
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-6 col-lg-5 mil-mb-60">
                                            ...
                                            <p class="mil-light-soft mil-up">Alisher Navoiy ko'chasi 25-uy <span class="mil-no-wrap">+998 73 249 2929</span></p>
                                        ...
                                        <div class="col-md-6 col-lg-5 mil-mb-60">
                                            ...
                                            <p class="mil-light-soft mil-up">Yunusobod tumani, Amir Temur shox ko'chasi 61-uy <span class="mil-no-wrap">+998 73 249 2929</span></p>
                                ...
                                <div class="col-md-4 col-lg-6 mil-mb-60">
                                    ...
                                    <div class="mil-vert-between">
                                        ...
                                        <p class="mil-light-soft mil-up">© 2024 | Barcha huquqlar himoyalangan - Baraka Development.</p>
                                    </div>
    ...
    <!-- jQuery js -->
    <script src="<?php echo e(asset('barakajobs/js/plugins/jquery.min.js')); ?>"></script>
    <!-- swup js -->
    <script src="<?php echo e(asset('barakajobs/js/plugins/swup.min.js')); ?>"></script>
    <!-- swiper js -->
    <script src="<?php echo e(asset('barakajobs/js/plugins/swiper.min.js')); ?>"></script>
    <!-- fancybox js -->
    <script src="<?php echo e(asset('barakajobs/js/plugins/fancybox.min.js')); ?>"></script>
    <!-- gsap js -->
    <script src="<?php echo e(asset('barakajobs/js/plugins/gsap.min.js')); ?>"></script>
    <!-- scroll smoother -->
    <script src="<?php echo e(asset('barakajobs/js/plugins/smooth-scroll.js')); ?>"></script>
    <!-- scroll trigger js -->
    <script src="<?php echo e(asset('barakajobs/js/plugins/ScrollTrigger.min.js')); ?>"></script>
    <!-- scroll to js -->
    <script src="<?php echo e(asset('barakajobs/js/plugins/ScrollTo.min.js')); ?>"></script>
    <!-- ashley js -->
    <script src="<?php echo e(asset('barakajobs/js/main.js')); ?>"></script>

</body>

</html>
<?php /**PATH /var/www/barakarasmiy/resources/views/frontend/pages/job.blade.php ENDPATH**/ ?>