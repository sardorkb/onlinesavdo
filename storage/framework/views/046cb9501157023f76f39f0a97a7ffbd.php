<?php $__env->startSection('title', 'Yetkazib berish | Baraka Development'); ?>
                ...
                <div class="row g-3 mb-9">
                    <div class="col-12">
                        <div class="whooping-banner w-100 rounded-3 overflow-hidden">
                            <img src="<?php echo e(asset('back/img/bannerlar/yetkazib-berish.jpg')); ?>" alt="reja">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/barakarasmiy/resources/views/frontend/pages/yetkazib-berish.blade.php ENDPATH**/ ?>