...
<head>
    ...
    <!-- bootstrap grid css -->
    <link rel="stylesheet" href="{{asset('barakajobs/css/plugins/bootstrap-grid.css')}}">
    <!-- font awesome css -->
    <link rel="stylesheet" href="{{asset('barakajobs/css/plugins/font-awesome.min.css')}}">
    <!-- swiper css -->
    <link rel="stylesheet" href="{{asset('barakajobs/css/plugins/swiper.min.css')}}">
    <!-- fancybox css -->
    <link rel="stylesheet" href="{{asset('barakajobs/css/plugins/fancybox.min.css')}}">
    <!-- ashley scss -->
    <link rel="stylesheet" href="{{asset('barakajobs/css/style.css')}}">
    <!-- page name -->
...
<body>
    ...
    <!-- jQuery js -->
    <script src="{{asset('barakajobs/js/plugins/jquery.min.js')}}"></script>
    <!-- swup js -->
    <script src="{{asset('barakajobs/js/plugins/swup.min.js')}}"></script>
    <!-- swiper js -->
    <script src="{{asset('barakajobs/js/plugins/swiper.min.js')}}"></script>
    <!-- fancybox js -->
    <script src="{{asset('barakajobs/js/plugins/fancybox.min.js')}}"></script>
    <!-- gsap js -->
    <script src="{{asset('barakajobs/js/plugins/gsap.min.js')}}"></script>
    <!-- scroll smoother -->
    <script src="{{asset('barakajobs/js/plugins/smooth-scroll.js')}}"></script>
    <!-- scroll trigger js -->
    <script src="{{asset('barakajobs/js/plugins/ScrollTrigger.min.js')}}"></script>
    <!-- scroll to js -->
    <script src="{{asset('barakajobs/js/plugins/ScrollTo.min.js')}}"></script>
    <!-- ashley js -->
    <script src="{{asset('barakajobs/js/main.js')}}"></script>
