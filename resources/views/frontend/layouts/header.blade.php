    ...
    <div class="container-md align-items-center" data-navbar="data-navbar">
        <ul class="navbar-nav mx-auto d-flex justify-content-evenly align-items-center">
            <li class="nav-item" data-nav-item="data-nav-item">
                <a class="text-decoration-none" href="{{ route('home') }}">
                    <div class="d-flex align-items-center">
                        <img src="{{ asset('back/img/logos/navbarlogolight.png') }}" alt="baraka" width="250" />
                    </div>
                </a>
            </li>
            ...
            <!-- <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link pe-3"
                    style="font-size: 14px; color: red;" href="{{ route('promotion') }}">% Aksiyalar</a></li> -->
            <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link pe-3" style="font-size: 14px;"
                    href="{{ route('contact') }}">Do'konlar</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link pe-3" style="font-size: 14px;"
                    href="{{ route('rassrochka') }}">Ta'rif rejasi</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link pe-3" style="font-size: 14px;"
                    href="{{ route('tulov') }}">Online to'lov</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link pe-3" style="font-size: 14px;"
                    href="{{ route('yetkazib-berish') }}">Yetkazib berish</a></li>
            <li class="nav-item" data-nav-item="data-nav-item"><a class="nav-link pe-3" style="font-size: 14px;"
                    href="{{ route('xizmatlar') }}">Xizmatlar va servis</a></li>
        </ul>
    </div>
</nav>
<!-- ============================================-->
                ...
                <div class="card border-0 scrollbar" style="max-height: 657px;">
                    <div class="card-body p-6 pb-3">
                        <div class="row gx-7 gy-5 mb-5">
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <h6 class="text-body-highlight mb-0 text-nowrap">{{ $parent_cat->title }}</h6>
                                ...
                                <div class="ms-n2">
                                    ...
                                    <a class="text-body-emphasis d-block mb-1 text-decoration-none bg-body-highlight-hover px-2 py-1 rounded-2"
                                        href="{{ route('product-sub-cat', ['slug' => $parent_cat->slug, 'sub_slug' => $child_cat->slug]) }}">{{ $child_cat->title }}</a>
                                    @endforeach
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="text-center border-top border-translucent pt-3"><a class="fw-bold"
                                href="{{ route('kategoriyalar')}}">Barcha kategoriyalar<span
            ...
            <div class="rowflex-between-evenly">
                <div class="col-auto order-md-1">
                    <ul class="navbar-nav navbar-nav-icons flex-row gap-6">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-2" href="{{ route('admin') }}" target="_blank">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link px-2" href="{{ route('user') }}">
                                <span class="text-body-tertiary" data-feather="user"
                                    style="height:25px;width:25px;"></span>
                            </a>
                        </li>
                        ...
                        @else
                        <li class="nav-item">
                            <a class="nav-link px-2" href="{{route('login.form')}}">
                                <span class="text-body-tertiary" data-feather="user"
                                    style="height:25px;width:25px;"></span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item dropdown ml-3">
                            <a class="nav-link px-2 icon-indicator icon-indicator-danger"
                                ...
                                <span class="text-body-tertiary">
                                    <i class="{{ Helper::wishlistCount() > 0 ? 'fas fa-heart' : 'far fa-heart' }}"
                                        style="font-size: 24px; color: {{ Helper::wishlistCount() > 0 ? '#00297D' : 'inherit' }};"></i>
                                </span>
                                <span class="icon-indicator-number">{{ Helper::wishlistCount() }}</span>
                            </a>
                            <div class="dropdown-menu custom-dropdown dropdown-menu-end"
                                ...
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header d-flex justify-content-between align-items-center">
                                        <span>{{ count(Helper::getAllProductFromWishlist()) }} dona mahsulot</span>
                                        <a class="btn btn-outline-info" style="font-size: 12px; padding: 3px 10px;"
                                            href="{{ route('wishlist') }}">Barcha saralanganlarni ko'rish</a>
                                    </div>
                                        ...
                                        <li class="shopping-list-item">
                                            ...
                                            <div class="shopping-list-item-right">
                                                ...
                                                <div class="quantity-price">
                                                    <p class="amount">{{ $data->quantity }} x UZS
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{ route('cart') }}" class="btn btn-outline-info"
                        ...
                        <li class="nav-item ml-3">
                            <a class="nav-link px-2 icon-indicator icon-indicator-primary" id="navbarTopDropdownCart"
                                ...
                                <span class="text-body-tertiary">
                                    <span class="text-body-tertiary">
                                        <i class="{{ Helper::wishlistCount() > 0 ? 'fas fa-shopping-cart' : 'fas fa-shopping-cart' }}"
                                            style="font-size: 24px; color: {{ Helper::wishlistCount() > 0 ? '#00297D' : 'inherit' }};"></i>
                                    </span>
                                </span>
                                <span class="icon-indicator-number">{{ Helper::cartCount() }}</span>
                            </a>
                            <!-- Dropdown Menu -->
                            <div class="dropdown-menu custom-dropdown dropdown-menu-end"
                                aria-labelledby="navbarTopDropdownNotification">
                                ...
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header d-flex justify-content-between align-items-center">
                                        <span>{{ count(Helper::getAllProductFromCart()) }} dona mahsulot</span>
                                        <a class="btn btn-outline-info" style="font-size: 12px; padding: 3px 10px;"
                                            href="{{ route('cart') }}">Savatchani ko'rish</a>
                                    </div>
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li class="shopping-list-item">
                                            ...
                                            <div class="shopping-list-item-right">
                                                ...
                                                <div class="quantity-price">
                                                    <p class="amount">
                                                        {{ $data->quantity }} x UZS {{ number_format($data->price, 2) }}
                                                    </p>
                                                </div>
                                    ...
                                    <div class="bottom">
                                        ...
                                        <a href="{{ route('checkout') }}" class="btn btn-outline-info"
