...
@section('title','Mahsulotni tahrirlash | Baraka Development')
@section('main-content')

<div class="card">
    <h5 class="card-header">Mahsulotni tahrirlash</h5>
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="cat_id">Kategoriya </label>
        ...
        <div class="form-group {{(($product->child_cat_id)? '' : 'd-none')}}" id="child_cat_div">
          <label for="child_cat_id">Paski kategoriya</label>
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Narxi (So'mda) </label>
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">Rasmi </label>
          <div class="input-group">
              <span class="input-group-btn">
                  <a id="lfm" data-input="thumbnail" data-preview="holder" class="btn btn-primary text-white">
                  <i class="fas fa-image"></i> Tanlang
                  </a>
              </span>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($product->status=='inactive')? 'selected' : '')}}>Aktiv emas</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
