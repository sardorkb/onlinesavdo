...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->youtube_link) {
            ...
            parse_str(parse_url($request->youtube_link, PHP_URL_QUERY), $youtubeParams);
            $data['youtube_link'] = $youtubeParams['v'] ?? null;
        }

        $status=Post::create($data);
        if($status){
            request()->session()->flash('success','Yangilik muvaffaqiyatli yuklandi');
        }
        else{
